...
public class Transitions implements Iterable<Transition> {
  ...
  public Transitions(Label from, Label to) {
    this.transitions.add(new Transition(from, to));
  }

  public Transitions(Label from, Constraint guard, Label to) {
    this.transitions.add(new Transition(from, Formula.atom(guard), to));
  }

  public Transitions(Label from, Formula guard, Label to) {
  ...
  public Transitions add(Transition t) {
    this.transitions.add(t);
    return this;
  }

  public Transitions add(Transitions t) {
