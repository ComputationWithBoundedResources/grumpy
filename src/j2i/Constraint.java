...
abstract public class Constraint implements PrettyPrint {
  ...
  public Constraint(AExpr lhs, AExpr rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }

  public static Constraint ge(AExpr lhs, AExpr rhs) {
    return new GeConstraint(lhs, rhs);
  }

  public static Constraint gt(AExpr lhs, AExpr rhs) {
    return new GtConstraint(lhs, rhs);
  }

  public static Constraint le(AExpr lhs, AExpr rhs) {
    return new LeConstraint(lhs, rhs);
  }

  public static Constraint lt(AExpr lhs, AExpr rhs) {
    return new LtConstraint(lhs, rhs);
  }

  public static Constraint eq(AExpr lhs, AExpr rhs) {
    return new EqConstraint(lhs, rhs);
  }

  public static Constraint as(AExpr lhs, AExpr rhs) {
...
class GeConstraint extends Constraint {
  ...
  public GeConstraint(AExpr lhs, AExpr rhs) {
    super(lhs, rhs);
  }
...
class GtConstraint extends Constraint {
  ...
  public GtConstraint(AExpr lhs, AExpr rhs) {
    super(lhs, rhs);
  }
...
class LeConstraint extends Constraint {
  ...
  public LeConstraint(AExpr lhs, AExpr rhs) {
    super(lhs, rhs);
  }
...
class LtConstraint extends Constraint {
  ...
  public LtConstraint(AExpr lhs, AExpr rhs) {
    super(lhs, rhs);
  }
...
class EqConstraint extends Constraint {
  ...
  public EqConstraint(AExpr lhs, AExpr rhs) {
    super(lhs, rhs);
  }
...
class AsConstraint extends Constraint {
  ...
  public AsConstraint(AExpr lhs, AExpr rhs) {
    super(lhs, rhs);
  }
